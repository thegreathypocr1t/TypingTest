...
QT_MOC_LITERAL(3, 31, 11), // "wordChecker"
QT_MOC_LITERAL(4, 43, 9), // "updateLcd"
QT_MOC_LITERAL(5, 53, 10), // "startCDown"
QT_MOC_LITERAL(6, 64, 24), // "on_actionAbout_triggered"
QT_MOC_LITERAL(7, 89, 23) // "on_actionHelp_triggered"

    },
    "TypingTest\0on_restart_clicked\0\0"
    "wordChecker\0updateLcd\0startCDown\0"
...
void TypingTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TypingTest *_t = static_cast<TypingTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_restart_clicked(); break;
        case 1: _t->wordChecker(); break;
        case 2: _t->updateLcd(); break;
        case 3: _t->startCDown(); break;
...
QT_INIT_METAOBJECT const QMetaObject TypingTest::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TypingTest.data,
      qt_meta_data_TypingTest,  qt_static_metacall, nullptr, nullptr}
};
